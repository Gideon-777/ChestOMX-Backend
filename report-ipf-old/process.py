...
parser.add_argument('--dicom', help='whether a study study should be added', action='store_true')
...
# image loading
scan = load_unify_image('./input/' + args.exam + '/*_0000.nii.gz')
dicoms = None
...
if args.lungs:
    print('lungs')
    lungs = load_unify_image('./input/' + args.exam + '/*_lung.nii.gz')
    if args.mask_flip:
...
if args.lobes or args.lobes3d:
    print('lobes common')
    lobes = load_unify_image('./input/' + args.exam + '/*_lobe.nii.gz')
    if args.mask_flip:
...
if args.ipf and (args.lobes or args.lobes3d):
    print('ipf')
    IPF = load_unify_image('./input/' + args.exam + '/*_infiltration.nii.gz')
    if args.mask_flip:
        IPF = flipMsk12(IPF)
    IPF.SetOrigin((0, 0, 0))
